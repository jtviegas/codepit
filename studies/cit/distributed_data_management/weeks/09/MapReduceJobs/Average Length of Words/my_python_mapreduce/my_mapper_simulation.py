...
# ------------------------------------------
def my_main():
    # 1. Select the directory and the extension
    #dir = "D:\\OneDrive - Cork Institute of Technology\\Modules\\DATA8005 - Distributed Data Management\\2. Code Examples\\L14-15. MapReduce Jobs\\Average Length of Words\\my_dataset"
    dir = "../my_dataset"
    ext = "txt"

    # 2. We open the file for writing
    output_file = open("map_simulation.txt", "w")

    # 3. We trigger the map_simulation
    simulating_my_map(dir, ext, output_file)
