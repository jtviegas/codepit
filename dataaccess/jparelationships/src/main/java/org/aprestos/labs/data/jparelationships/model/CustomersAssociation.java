...
public class CustomersAssociation {
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "customer_association_id_seq")
  @SequenceGenerator(name = "customer_association_id_seq", schema = "core", sequenceName = "CUSTOMER_ASSOCIATION_ID_SEQ", allocationSize = 100)
  private Long id;
