...
import org.exercises.jtamv.challenges.areawith10players.ChangeListener.ChangeType;
 ...
 *
 */
public class Player implements ChangeProvider, Runnable {

    public static enum State {
	ON, YELLOWED, EJJECTED, ELIGIBLE2PLAY, OFF
    };
	...
	notifyListeners(ChangeType.ELIGIBILITY_QUERY);
    }
	...
	//debug("moved");
	notifyListeners(ChangeType.MOVEMENT);
    }
