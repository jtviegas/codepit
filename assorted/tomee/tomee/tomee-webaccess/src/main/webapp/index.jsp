...
<head>
  ...
  <link href="<c:url value='/webjars/codemirror/3.21/lib/codemirror.css'/>" rel="stylesheet">
  <link href="<c:url value='/webjars/codemirror/3.21/addon/hint/show-hint.css'/>" rel="stylesheet">
