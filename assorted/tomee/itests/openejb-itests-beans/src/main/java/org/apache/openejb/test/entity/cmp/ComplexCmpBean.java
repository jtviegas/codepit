...
public class ComplexCmpBean implements EntityBean {
    ...
    public ComplexCmpBeanPk getPrimaryKey() {
        return new ComplexCmpBeanPk(firstName, lastName);
    }
     ...
     *
     * @return
     * @see org.apache.openejb.test.entity.cmp.BasicCmpObject#getPermissionsReport
     */
