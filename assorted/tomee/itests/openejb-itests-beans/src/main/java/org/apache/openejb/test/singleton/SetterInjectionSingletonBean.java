...
public class SetterInjectionSingletonBean implements SessionBean {
    ...
    public void setSingletonBusinessRemote(BasicSingletonBusinessRemote singletonBusinessRemote) {
    ...
    public void setSingletonHome(BasicSingletonHome singletonHome) {
