 ...
 *
 */
public class StatelessAnnotatedFieldInjectionTests extends StatefulTestClient {

    protected EncStatelessHome   ejbHome;
    protected EncStatelessObject ejbObject;

    public StatelessAnnotatedFieldInjectionTests(){
        super("FieldInjection.");
    }

    protected void setUp() throws Exception{
        super.setUp();
        Object obj = initialContext.lookup("AnnotatedFieldInjectionStatelessBean");
