...
public class SessionBean$JAXB
    ...
    public final static SessionBean _read(XoXMLStreamReader reader, RuntimeContext context)
            throws Exception {
        ...
        for (XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName()) && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                String businessLocalItemRaw = elementReader.getElementAsString();
                ...
                String businessRemoteItemRaw = elementReader.getElementAsString();
                ...
                String serviceEndpointRaw = elementReader.getElementAsString();
                ...
                // ELEMENT: sessionType
                SessionType sessionType = parseSessionType(elementReader, context, elementReader.getElementAsString());
                if (sessionType != null) {
                ...
                Boolean initOnStartup = ("1".equals(elementReader.getElementAsString()) || "true".equals(elementReader.getElementAsString()));
                ...
                ConcurrencyManagementType concurrencyManagementType = parseConcurrencyManagementType(elementReader, context, elementReader.getElementAsString());
    ...
    public final static void _readDependsOn(XoXMLStreamReader reader, RuntimeContext context, SessionBean sessionBean)
            throws Exception {
        ...
        for (XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("ejb-name" == elementReader.getLocalName()) && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: dependsOn
                String dependsOnItemRaw = elementReader.getElementAsString();
    ...
    public final static void _write(XoXMLStreamWriter writer, SessionBean sessionBean, RuntimeContext context)
            throws Exception {
        if (sessionBean == null) {
            writer.writeXsiNil();
            return;
