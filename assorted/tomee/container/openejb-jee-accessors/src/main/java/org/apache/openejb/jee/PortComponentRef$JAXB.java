...
public class PortComponentRef$JAXB
    ...
    public final static PortComponentRef _read(XoXMLStreamReader reader, RuntimeContext context)
            throws Exception {
        ...
        for (XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("service-endpoint-interface" == elementReader.getLocalName()) && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                String portComponentLinkRaw = elementReader.getElementAsString();
    ...
    public final static void _write(XoXMLStreamWriter writer, PortComponentRef portComponentRef, RuntimeContext context)
            throws Exception {
