...
public class JavaMailSessionBuilder extends Resource {


    public JavaMailSessionBuilder() {
        setClassName("org.apache.openejb.core.MailSessionFactory");
        setType("javax.mail.Session");
        setId("JavaMailSession");
