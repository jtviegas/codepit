 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://jboss.org}sql-statement" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "post-table-create")
public class PostTableCreate {

    @XmlElement(name = "sql-statement", required = true)
    protected List<SqlStatement> sqlStatement;
