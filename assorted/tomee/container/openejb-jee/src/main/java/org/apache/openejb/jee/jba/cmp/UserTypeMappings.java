 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://jboss.org}user-type-mapping" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "user-type-mappings")
public class UserTypeMappings {

    @XmlElement(name = "user-type-mapping", required = true)
    protected List<UserTypeMapping> userTypeMapping;
