...
public class JcsMemoryAndDiskIntegrationTest extends MemoryCacheTestAbstract {
	
	private ApplicationContext context;
	
	public JcsMemoryAndDiskIntegrationTest() {
		super();
		//load spring config
	...
	protected ICache<String, String> setUpCache() {
		return (ICache<String, String>)context.getBean("jcsMemoryAndDiskCache");
	}
