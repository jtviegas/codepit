...
public class LinkedHashMapIntegrationTest extends MemoryCacheTestAbstract {
	
	private ApplicationContext context;
	
	public LinkedHashMapIntegrationTest() {
		super();
		//load spring config
	...
	protected ICache<String, String> setUpCache() {
		return (ICache<String, String>)context.getBean("linkedHashmapCache");
	}
