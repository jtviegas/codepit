...
@Component("jcsMemoryCache")
public class JcsMemoryCache implements ICache<String, String> {

	private static final String REGION = "default";
	private JCS cache;
	
	public JcsMemoryCache() throws org.apache.jcs.access.exception.CacheException {
