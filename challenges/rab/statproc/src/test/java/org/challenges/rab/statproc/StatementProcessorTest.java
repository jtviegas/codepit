...
public class StatementProcessorTest {
  ...
  private StatementProcessorFactory factory;
  
  @Before
  public void setup() {
    factory = new StatementProcessorFactory();
  }
  
	@Test(expected = IllegalArgumentException.class)
	public void test_null_csv() throws Exception {
		StatementProcessor processor = factory.getStatementProcessor(FileType.CSV);
	...
	public void test_null_xml() throws Exception {
		StatementProcessor processor = factory.getStatementProcessor(FileType.XML);
		processor.process(null);
		Assert.fail();
	}
