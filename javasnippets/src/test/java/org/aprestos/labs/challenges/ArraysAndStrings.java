...
public class ArraysAndStrings {
	...
	public void test() throws Exception {
		...
		Assert.assertEquals(3, newYearChaos2(new int[] { 2, 1, 5, 3, 4 }));
		Assert.assertEquals(-1, newYearChaos2(new int[] { 2, 5, 1, 3, 4 }));
		Assert.assertEquals(7, newYearChaos2(new int[] { 1, 2, 5, 3, 7, 8, 6, 4 }));
		...
		Assert.assertEquals(966, newYearChaos2(strToIntArray(input)));
	...
	private int newYearChaos2(int[] q) {
	 ...
	 private int newYearChaos3(int[] q) {
