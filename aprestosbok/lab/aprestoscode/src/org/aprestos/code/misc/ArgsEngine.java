/*
 * ArgsEngine.java Copyright (C) Wincor Nixdorf.
 */
/**
 * 
 */
...
public class ArgsEngine
{
     ...
     */
    private List nonOptions = new ArrayList();
    ...
    public void parse(String[] args)
    {
        ...
        for (int i = 0; i < args.length; i++)
        {
            ...
            {
                Option option = (ArgsEngine.Option)this.options.get(arg);
    ...
    public String[] getNonOptions()
    {
        ...
        return (String[])this.nonOptions.toArray(new String[this.nonOptions.size()]);
    }
    ...
    public String getString(String key)
    {
        ...
        Option option = (ArgsEngine.Option)this.options.get(key);
