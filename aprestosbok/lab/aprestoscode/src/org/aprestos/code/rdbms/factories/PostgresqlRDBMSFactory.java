...
import org.aprestos.code.rdbms.impl.PostgresqlRDBMSImpl;
 ...
 * @author jmv
 */
public class PostgresqlRDBMSFactory extends AbstractRDBMSFactory
{
	private static LoggerInterface logger = LoggerFactory.getInstance()
			.getLogger(PostgresqlRDBMSFactory.class);

	private Properties properties;
	private RDBMSInterface rdbms;

	public PostgresqlRDBMSFactory(Properties properties)
	{
	...
	public void initialize() throws RDBMSInitializeException
	{
		...
		try
		{
			rdbms = new PostgresqlRDBMSImpl(this.properties);
		}
		catch(Exception x)
		{
